...
export const Barn: React.FC<Props> = ({ farmSize, balance }) => {
  ...
  return (
    <>
      ...
      <div
        className="dirt"
        style={{ gridColumn: "11/12", gridRow: "8/9" }}
      />
      <div
        className="dirt"
        style={{ gridColumn: "12/13", gridRow: "8/9" }}
      />
      <div
        className="dirt"
        style={{ gridColumn: "13/14", gridRow: "8/9" }}
      />
      <div
        className="dirt"
      ...
      <div
        className="dirt"
        style={{ gridColumn: "11/12", gridRow: "9/10" }}
      />
      <div
        className="dirt"
        style={{ gridColumn: "12/13", gridRow: "9/10" }}
      />
      <div
        className="dirt"
        style={{ gridColumn: "13/14", gridRow: "9/10" }}
      />
      <div
        className="dirt"
      ...
      <div
        className="dirt"
        style={{ gridColumn: "13/14", gridRow: "10/11" }}
      />
      <div
        className="dirt"
      ...
      <div style={{ gridColumn: "12/13", gridRow: "7/8" }}>
        <div id="house">
          ...
          {farmSize > 5 && <img id="level" src={level} />}
          {farmSize > 8 && <img id="side-house" src={sideHouse} />}

          {farmSize === 14 && <img id="side-house2" src={sideHouse3} />}
          {farmSize === 17 && [
